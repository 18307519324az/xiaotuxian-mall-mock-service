...
public class GoodsMockService {
    ...
    public JSONObject buildGoodsDetail(String id) {
        ...
        result.set("availableStock", MockStockUtils.availableStock(p));
        result.set("lowStockThreshold", MockStockUtils.lowStockThreshold(p));
        result.set("stockStatus", MockStockUtils.stockStatus(p));
        ...
        if (skuIds != null && masterSkus != null) {
            for (int i = 0; i < skuIds.size(); i++) {
                ...
                if (sku != null) {
                    ...
                    skuOut.set("availableStock", MockStockUtils.availableStock(sku));
                    skuOut.set("lowStockThreshold", MockStockUtils.lowStockThreshold(sku));
                    skuOut.set("stockStatus", MockStockUtils.stockStatus(sku));
        ...
        if (masterSkus != null) {
            for (Map.Entry<String, Object> entry : masterSkus.entrySet()) {
                ...
                if (productId.equals(sProductId)) {
                    ...
                    slim.set("availableStock", MockStockUtils.availableStock(s));
                    slim.set("stockStatus", MockStockUtils.stockStatus(s));
    ...
    public JSONObject queryStock(String skuId) {
        ...
        result.set("availableStock", MockStockUtils.availableStock(sku));
        result.set("stock", MockStockUtils.availableStock(sku));
        result.set("stockStatus", MockStockUtils.stockStatus(sku));
        result.set("lowStockThreshold", MockStockUtils.lowStockThreshold(sku));
    ...
    public JSONObject toGoodsCard(JSONObject product) {
        ...
        card.set("availableStock", MockStockUtils.availableStock(product));
        card.set("stockStatus", MockStockUtils.stockStatus(product));
